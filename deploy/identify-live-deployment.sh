...
echo "3. Compose project label 'speechinsight2' + service 'app' + name 'speechinsight2' = GitHub Actions deploy."
echo "4. Compose service 'speechinsight' + name 'speechinsight-api' + image 'speechinsight2-speechinsight' = legacy orphan."
echo "5. Do NOT docker rm until public /api/health matches the container you intend to keep."
